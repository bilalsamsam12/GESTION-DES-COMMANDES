...
public class updateprod extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String marque=request.getParameter("marquep");
         String imgp=request.getParameter("imagep");
        ...
        try {
            PreparedStatement prst = con.prepareStatement("update produit set nom_p=?,marque=?,image=? where idprod=?");
            prst.setString(1, nomp);
            prst.setString(2, marquep);
            prst.setString(3, imgp);
            prst.setInt(4, idp);
